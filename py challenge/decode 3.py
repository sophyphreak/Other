# -*- coding: utf-8 -*-
"""
Created on Fri Mar  3 20:59:39 2017
...
for i in range(len(crap)):
    if crap[i] in "abcdefghijklmnopqrstuvwxyz":
        if crap[i+1] in "ABCDEFGHIJKLMNOPQRSTUVWXYZ":
            if crap[i+2] in "ABCDEFGHIJKLMNOPQRSTUVWXYZ":
                if crap[i+3] in "ABCDEFGHIJKLMNOPQRSTUVWXYZ":
                    if crap[i+4] in "abcdefghijklmnopqrstuvwxyz":
                        if crap[i+5] in "ABCDEFGHIJKLMNOPQRSTUVWXYZ":
                            if crap[i+6] in "ABCDEFGHIJKLMNOPQRSTUVWXYZ":
                                if crap[i+7] in "ABCDEFGHIJKLMNOPQRSTUVWXYZ":
                                    if crap[i+8] in "abcdefghijklmnopqrstuvwxyz":
                                        message += crap[i+4]
print(message)